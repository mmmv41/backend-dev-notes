...
public class Application3 {
    public static void main(String[] args) {
        ...
        /* 설명
         *   문자열을 특정 구분자로 하여 분리한 문자열들을 반환하는 기능을 한다.
         *   1. split() : 정규표현식을 이용하여 비정형화된 문자열을 분리한다.
         *          (String을 파싱하여 String[]로 변환해주고 [](대괄호) 활용하여 구분자들을 넣어줄 수 있다.
         *   2. StringTokenizer : 문자열의 모든 문자들을 구분자를 활용하여 문자열이 분리된다.
         *          (StringToknizer가 제공하는 메소드와 while문을 활용하여 띄어쓰기로 구분된 구분자들을 넣어줄 수 있다)
         * */
