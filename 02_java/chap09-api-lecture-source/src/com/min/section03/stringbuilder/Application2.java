package com.min.section03.stringbuilder;

public class Application2 {
    public static void main(String[] args) {

        /* 수업목표
         *   StringBuilder의 자주 사용되는 메소드 용법 및 원리를 이해할 수 있다. */
         ...
         * */
        System.out.println("delete(): " + sb.delete(2, 5)); // 2번 인덱스 ~ 4번 인덱스까지 자른다.
        System.out.println("deleteCharAt(): " + sb.deleteCharAt(2));

        /* 설명
         *   insert() : 인자로 전달된 값을 문자열로 변환 후 지정된 인덱스 위치에 추가한다. */
        System.out.println("insert(): " + sb.insert(1, "vao")); // offset: default 위치
