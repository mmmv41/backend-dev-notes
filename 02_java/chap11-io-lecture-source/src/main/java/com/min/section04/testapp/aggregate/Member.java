package com.min.section04.testapp.aggregate;
...
public class Member implements Serializable {
    ...
    public Member(int memNo, String id, String pwd, int age, String[] hoobies, BloodType bloodType,
    ...
    public String toString() {
        return "Member{" +
                ...
                ", pwd='" + pwd + '\'' +
                ", age=" + age +
                ", hoobies=" + Arrays.toString(hobbies) +
                ", bloodType=" + bloodType +
                ", accountStatus=" + accountStatus +
                '}';
    }
